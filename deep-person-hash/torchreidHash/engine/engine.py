...
from torchreidHash.losses import DeepSupervision
    ...
    def _evaluate(
        ...
        def _feature_extraction(data_loader):
            ...
            for batch_idx, data in enumerate(data_loader):
                ...
                # _,v= self._extract_features(imgs)
                # _,v,h,b,_,_= self._extract_features(imgs)
                _,v,h,b,_,_= self._extract_features(imgs)
                # elapsed_time = round(time.time()*1000 - end*1000)/100.0
                # print("提取时间：",elapsed_time)
                # elapsed_time = str(datetime.timedelta(seconds=elapsed_time))
                # print('平均提取特征时间 {}'.format(elapsed_time))
                ...
                #---------------------------------
                # features = features.data.sign().cpu()
